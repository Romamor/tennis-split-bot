...
Текущий код использует версию схемы 4; таблиц по-прежнему 13. SQL находится в [schema.sql](../src/main/resources/db/schema.sql).
...
В groups добавлено `default_start_time` — время начала новых тренировок HH:mm,
по умолчанию 18:30. Его меняет администратор только своей группы. Обновление
названия чата из Telegram сохраняет настройку; существующие тренировки не меняются.
