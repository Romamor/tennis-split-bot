...
Текущий код использует версию схемы 7; таблиц 15. SQL находится в [schema.sql](../src/main/resources/db/schema.sql).
...
- `polls_enabled` — разрешены ли новые опросы перед тренировками; по умолчанию 0. Настройка уже используется в интерфейсе.
...
[ERD базы в draw.io](diagrams/DATABASE_ERD.drawio) — шесть вкладок: обзор, аккаунты и группы, тренировки, финансы, состояние бота, опросы. Показаны 15 таблиц, 121 поле и 39 внешних ключей текущей схемы.
