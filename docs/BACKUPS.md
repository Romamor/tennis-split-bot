...
Схема9 добавляет необязательный идентификатор фото к опросу. Перед установкой новой
версии нужна согласованная копия базы схемы8. Финансовые данные и изображения при
миграции не переписываются: само фото остаётся на серверах Telegram. Для возврата
к программе, понимающей только схему8, используйте проверенную копию до обновления;
не подменяйте рабочую базу старой копией после новых действий пользователей.
