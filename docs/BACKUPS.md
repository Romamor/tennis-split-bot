...
10 сентября 2026. Обзор и локальные исправления подготовлены; расписание,
...
При прогнозе около 10–12 МиБ сама база мала; важнее независимость копий и проверка восстановления.
...
WAL, истории и балансов восстановленной копии. Новый механизм ещё не установлен на VDS.
Текущий старый контейнер использует прежний VACUUM INTO; перед обновлением копию
нужно делать совместимым инструментом, который не мигрирует источник.

После разрешённой установки новой версии команда остаётся такой же:
