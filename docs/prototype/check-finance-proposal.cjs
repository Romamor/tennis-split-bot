...
assert.deepEqual(await balances(),[['Борис','+450 ₽'],['Вера','−150 ₽'],['Алексей','−300 ₽'],['Глеб','0 ₽'],['Денис','0 ₽']]);
await click('›');assert.deepEqual(await balances(),[['Елена','0 ₽'],['Ирина','0 ₽'],['Кирилл','0 ₽']]);await click('Назад');
