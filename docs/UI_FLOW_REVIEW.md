...
В общей карточке рядом с «Открыть» стоит ссылка «Редактировать» в личку, с проверкой
создателя или администратора. Внутри персональных панелей её нет. После учёта
...
Суперадминистратор: главное меню → «⚙️ Настройки группы» → «👥 Администраторы группы».
«⬅️ Назад» из списка возвращает в настройки. В главном меню отдельного пункта нет.
Назначенный администратор бота видит настройки времени, но не управление назначениями.
