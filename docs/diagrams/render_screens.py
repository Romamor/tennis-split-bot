...
def resolve(key,b):
 ...
 if k in ('settings','default_time'):return [k]
 if k=='save_default_time':return ['settings']
...
input_next={'default_time':'default_time','new_title':'new_date','new_date':'new_time','new_time':'new_ready','edit_title':'edit_date','edit_date':'edit_time','edit_time':'edit_ready','transfer_amount':'transfer_ready','transfer_date':'transfer_ready','transfer_note':'transfer_ready','edit_transfer_amount':'edit_transfer_ready','paid':'player','pick_players':'add_players'}
